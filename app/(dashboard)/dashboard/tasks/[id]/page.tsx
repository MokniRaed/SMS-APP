...
import { getTask, taskTypes, taskStatuses, assignTask, acceptTask, planTask, startTask, completeTask, cancelTask } from '@/lib/services/tasks';
...
import { CalendarDays, MapPin, FileText, User, Briefcase, ArrowLeft, Pencil, Check } from 'lucide-react';
      ...
      <div className="w-full py-4">
        <div className="flex justify-between">
          {TASK_PHASES.map((phase, index) => {
            const isActive = index <= currentPhaseIndex && task.statut_tache !== '5';
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end space-x-2">
              {task.statut_tache === '1' && (
                <Button onClick={() => updateMutation.mutate({ action: 'start' })}>
                  Start Task
                </Button>
              )}
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{task.id_collaborateur}</p>
                </div>
              </div>
            </div>
